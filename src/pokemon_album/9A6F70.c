...
extern Sprite D_801E4518_9AE768_sprite;
extern Sprite D_801ED550_9B77A0_sprite;
extern Sprite D_801F2D28_9BCF78_sprite;
extern Sprite D_801F2F88_9BD1D8_sprite;
extern Sprite D_801F3108_9BD358_sprite;
extern Sprite D_801F3288_9BD4D8_sprite;
extern Sprite D_801F3408_9BD658_sprite;
extern Sprite D_801F3588_9BD7D8_sprite;
extern Sprite D_801F6B50_9C0DA0_sprite;
extern Sprite D_801FB1D0_9C5420_sprite;
extern Sprite D_801FFA10_9C9C60_sprite;
extern Sprite D_801FFC80_9C9ED0_sprite;
extern Sprite D_80200058_9CA2A8_sprite;
extern Sprite D_80200400_9CA650_sprite;
extern Sprite D_802005B8_9CA808_sprite;
extern Sprite D_802006E8_9CA938_sprite;
extern Sprite D_80201728_9CB978_sprite;
extern Sprite D_80208B10_9D2D60_sprite;
...
GObj* album_CreatePhoto(s32 index) {
    ...
    gobj = func_80371C68_845418(NULL, LINK_6, &D_802005B8_9CA808_sprite);
    sobj = gobj->data.sobj;
    sobj->sprite.x = x;
    sobj->sprite.y = y;
    album_Photos[index].gObj = gobj;

    sobj = func_80371E68_845618(sobj, &D_802005B8_9CA808_sprite);
    sobj->sprite.x = 54;
    sobj->sprite.y = 0;

    sobj = func_80371DC0_845570(sobj, &D_802006E8_9CA938_sprite);
    sobj->sprite.x = 2;
    sobj->sprite.y = 0;
    ...
    sobj = func_80371DC0_845570(sobj, &D_80201728_9CB978_sprite);
    sobj->sprite.x = 2;
    sobj->sprite.y = 2;
...
void* func_801DE0C8_9A8318(void) {
    ...
    gobj = func_80371C68_845418(NULL, LINK_6, &D_80200058_9CA2A8_sprite);
    ...
    sobj = func_80371E68_845618(sobj, &D_80200058_9CA2A8_sprite);
    sobj->sprite.x = 143;
    sobj->sprite.y = 0;

    sobj = func_80371DC0_845570(sobj, &D_80200400_9CA650_sprite);
    sobj->sprite.x = 3;
    sobj->sprite.y = 0;
    ...
    sobj = func_80371DC0_845570(sobj, &D_80208B10_9D2D60_sprite);
    sobj->sprite.x = 3;
    sobj->sprite.y = 3;
...
GObj* album_CreatePhotoCorners(void) {
    ...
    for (i = 0; i < 2; i++) {
        for (j = 0; j < 3; j++) {
            gobj = func_80371C68_845418(NULL, LINK_6, &D_801F3108_9BD358_sprite);
            sobj = gobj->data.sobj;
            album_PhotoCorners[(i * 3) + j] = sobj;
            sobj->sprite.x = (j * 66) + 102;
            sobj->sprite.y = (i * 55) + 51;
            sobj->sprite.attr |= SP_HIDDEN;
            sobj = func_80371E68_845618(sobj, &D_801F3288_9BD4D8_sprite);
            sobj->sprite.x = 48;
            sobj->sprite.y = 0;
            sobj = func_80371DC0_845570(sobj, &D_801F3408_9BD658_sprite);
            sobj->sprite.x = 0;
            sobj->sprite.y = 36;
            sobj = func_80371DC0_845570(sobj, &D_801F3588_9BD7D8_sprite);
            sobj->sprite.x = 48;
            sobj->sprite.y = 36;
        }
    }
...
void* album_CreateCommentBackground(void) {
    ...
    gobj = func_80371C68_845418(NULL, LINK_6, &D_801F6B50_9C0DA0_sprite);
    sobj = gobj->data.sobj;
...
GObj* album_CreateCommentTextBox(void) {
    ...
    gobj = func_80371C68_845418(NULL, LINK_6, &D_801FFC80_9C9ED0_sprite);
    sobj = gobj->data.sobj;
    sobj->sprite.x = 115;
    sobj->sprite.y = 196;
...
void* album_CreatePhotoDescBackground(void) {
    ...
    gobj = func_80371C68_845418(NULL, LINK_6, &D_801FB1D0_9C5420_sprite);
    sobj = gobj->data.sobj;
...
void album_CreateCoverUI(void) {
    ...
    gobj = func_80371D14_8454C4(NULL, LINK_6, &D_801F2D28_9BCF78_sprite);
    sobj = gobj->data.sobj;
    sobj->sprite.x = 106;
    sobj->sprite.y = 52;
    album_CoverTitleSObj[0] = sobj;

    sobj = func_80371DC0_845570(sobj, &D_801ED550_9B77A0_sprite);
    sobj->sprite.x = 110;
    sobj->sprite.y = 108;
...
void func_801DF2E0_9A9530(void) {
    ...
    sobj->sprite = D_801F2D28_9BCF78_sprite;
    sobj->sprite.x = 106;
    sobj->sprite.y = 52;
    sobj->unk_58 = NULL;
    sobj->unk_5C = NULL;
    ...
    sobj->sprite = D_801ED550_9B77A0_sprite;
    sobj->sprite.x = 110;
    sobj->sprite.y = 108;
    sobj->sprite.alpha = 128;
    sobj->sprite.attr |= SP_TRANSPARENT;
...
void album_SetBackgroundTexture(bool arg0) {
    ...
    if (arg0) {
        sobj->sprite = D_801F2F88_9BD1D8_sprite;
    } else {
        sobj->sprite = D_801E4518_9AE768_sprite;
    }
...
void album_CreateUI(void) {
    ...
    bgObj = func_80371D14_8454C4(NULL, LINK_6, &D_801E4518_9AE768_sprite);
