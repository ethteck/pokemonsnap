...
void func_8001ED60(Vec3f* arg0, Vec3f* _arg1, f32 arg2, f32 arg3) {
    Vec3f* arg1 = _arg1;
    f32 temp_f0;
    f32 w0, w1, w2, w3;
    f32 temp_f2;
    ...
    w0 = (2.0f * temp_f0 - temp_f2 - arg3) * arg2;
    w1 = (2.0f - arg2) * temp_f2 + (arg2 - 3.0f) * temp_f0 + 1.0f;
    w2 = (arg2 - 2.0f) * temp_f2 + (3.0f - 2.0f * arg2) * temp_f0 + arg2 * arg3;
    w3 = (temp_f2 - temp_f0) * arg2;
...
void func_8001EEA4(Vec3f* arg0, Vec3f* _arg1, f32 arg2, f32 arg3) {
    Vec3f* arg1 = _arg1;
    f32 temp_f0;
    f32 w0, w1, w2, w3;
    ...
    w0 = (-3.0f * temp_f0 + 4.0f * arg3 - 1.0f) * arg2;
    w1 = (2.0f - arg2) * 3.0f * temp_f0 + 2.0f * (arg2 - 3.0f) * arg3;
    w2 = (arg2 - 2.0f) * 3.0f * temp_f0 + 2.0f * (3.0f - 2.0f * arg2) * arg3 + arg2;
    w3 = (3.0f * temp_f0 - 2.0f * arg3) * arg2;
...
void func_8001F030(Vec3f* arg0, Vec3f* _arg1, f32 arg2) {
    Vec3f* arg1 = _arg1;
    f32 temp_f0;
    f32 temp_f14;
    f32 w0, w1, w2, w3;
    ...
    w0 = (1.0f / 6.0f) * temp_f0 * temp_f0 * temp_f0;
    w1 = (1.0f / 6.0f) * (3.0f * temp_f14 - 6.0f * temp_f2 + 4.0f);
    w2 = (1.0f / 6.0f) * (3.0f * (temp_f2 - temp_f14 + arg2) + 1.0f);
    w3 = (1.0f / 6.0f) * temp_f14;
