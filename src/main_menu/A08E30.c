...
extern Sprite D_802DB328_main_menu_vpk0;
extern Sprite D_802DB588_main_menu_vpk0;
extern Sprite D_802DBCE8_main_menu_vpk0;
extern Sprite D_802DC1A8_main_menu_vpk0;
extern Sprite D_802DC718_main_menu_vpk0;
extern Sprite D_802DC978_main_menu_vpk0;
extern Sprite D_802DCE88_main_menu_vpk0;
extern Sprite D_802DFAB0_main_menu_vpk0;
extern Sprite D_802E8DD0_main_menu_vpk0;
extern Sprite D_802F20F0_main_menu_vpk0;
extern Sprite D_802F4828_main_menu_vpk0;
extern Sprite D_802F6490_main_menu_vpk0;
extern Sprite D_802F82C8_main_menu_vpk0;
extern Sprite D_80309770_main_menu_vpk0;
extern Sprite D_8030A4E0_main_menu_vpk0;
extern Sprite D_8030B250_main_menu_vpk0;
extern Sprite D_8030BFC0_main_menu_vpk0;
extern Sprite D_8030E020_main_menu_vpk0;
extern Sprite D_80310080_main_menu_vpk0;
extern Sprite D_803120E0_main_menu_vpk0;
extern Sprite D_8034B020_main_menu_vpk0;
extern Sprite D_8034B920_main_menu_vpk0;
extern Sprite D_8034BBB8_main_menu_vpk0;
extern Sprite D_8034C4B0_main_menu_vpk0;
extern Sprite D_8034C710_main_menu_vpk0;
extern Sprite D_8034D3A0_main_menu_vpk0;
extern Sprite D_8034FAD8_main_menu_vpk0;
...
void func_800E1E10_A093A0(void) {
    ...
    gobj = D_800E82B4_A0F844 = ohCreateSprite(0xE, ohUpdateDefault, 0, 0x80000000, renDrawSprite, 1, 0x80000000, -1,
                                              &D_802DB328_main_menu_vpk0, 0, NULL, 1);
    ...
    omGObjAddSprite(gobj, &D_802DB588_main_menu_vpk0);
    ...
    sobj->sprite.scalex = 1.2f;
    sobj->sprite.scaley = 1.2f;
    omGObjAddSprite(gobj, &D_802DBCE8_main_menu_vpk0);
    ...
    sobj->sprite.scalex = 1.2f;
    sobj->sprite.scaley = 1.2f;
    omGObjAddSprite(gobj, &D_802DC1A8_main_menu_vpk0);
    ...
    sobj->sprite.scalex = 1.2f;
    sobj->sprite.scaley = 1.2f;
    omGObjAddSprite(gobj, &D_802DC718_main_menu_vpk0);
    ...
    sobj->sprite.scalex = 1.2f;
    sobj->sprite.scaley = 1.2f;
    omGObjAddSprite(gobj, &D_802DC978_main_menu_vpk0);
    ...
    sobj->sprite.scalex = 1.2f;
    sobj->sprite.scaley = 1.2f;
    omGObjAddSprite(gobj, &D_802DCE88_main_menu_vpk0);
    ...
    sobj->sprite.scalex = 1.2f;
    sobj->sprite.scaley = 1.2f;
    omGObjAddSprite(gobj, &D_802DFAB0_main_menu_vpk0);
...
void func_800E212C_A096BC(void) {
    ...
    gobj = D_800E82C0_A0F850 = ohCreateSprite(0xE, ohUpdateDefault, 0, 0x80000000, renDrawSprite, 1, 0x80000000, -1,
                                              &D_80309770_main_menu_vpk0, 0, NULL, 1);
    sobj = gobj->data.sobj;

    func_800E18FC_A08E8C(sobj, 0, 172);
    func_800E18A0_A08E30(sobj, SP_TEXSHUF | SP_HIDDEN | SP_TRANSPARENT);
    omGObjAddSprite(gobj, &D_8030A4E0_main_menu_vpk0);

    sobj = sobj->next;
    func_800E18FC_A08E8C(sobj, 0, 172);
    func_800E18A0_A08E30(sobj, SP_TEXSHUF | SP_HIDDEN | SP_TRANSPARENT);
    omGObjAddSprite(gobj, &D_8030B250_main_menu_vpk0);

    sobj = sobj->next;
    func_800E18FC_A08E8C(sobj, 0, 172);
    func_800E18A0_A08E30(sobj, SP_TEXSHUF | SP_HIDDEN | SP_TRANSPARENT);
    omGObjAddSprite(gobj, &D_8030BFC0_main_menu_vpk0);
    ...
    gobj = D_800E82C4_A0F854 = ohCreateSprite(0xE, ohUpdateDefault, 0, 0x80000000, renDrawSprite, 1, 0x80000000, -1,
                                              &D_8030E020_main_menu_vpk0, 0, NULL, 1);
    sobj = gobj->data.sobj;

    func_800E18FC_A08E8C(sobj, 0, 150);
    func_800E18A0_A08E30(sobj, SP_TEXSHUF | SP_HIDDEN | SP_TRANSPARENT);
    omGObjAddSprite(gobj, &D_80310080_main_menu_vpk0);

    sobj = sobj->next;
    func_800E18FC_A08E8C(sobj, 0, 150);
    func_800E18A0_A08E30(sobj, SP_TEXSHUF | SP_HIDDEN | SP_TRANSPARENT);
    omGObjAddSprite(gobj, &D_803120E0_main_menu_vpk0);
...
void func_800E2348_A098D8(void) {
    ...
    gobj = D_800E82C8_A0F858 = ohCreateSprite(0xE, ohUpdateDefault, 0, 0x80000000, renDrawSprite, 1, 0x80000000, -1,
                                              &D_802F4828_main_menu_vpk0, 0, NULL, 1);
    sobj = gobj->data.sobj;
...
void func_800E23E4_A09974(void) {
    ...
    gobj = D_800E82CC_A0F85C = ohCreateSprite(0xE, ohUpdateDefault, 0, 0x80000000, renDrawSprite, 1, 0x80000000, -1,
                                              &D_8034B920_main_menu_vpk0, 0, NULL, 1);
    if (1) {
    }
    if (1) {
    }
    if (1) {
    } // TODO 3 if 1s required to match
    sobj = gobj->data.sobj;
...
void func_800E2480_A09A10(void) {
    ...
    gobj = D_800E82D0_A0F860 = ohCreateSprite(0xE, ohUpdateDefault, 0, 0x80000000, renDrawSprite, 1, 0x80000000, -1,
                                              &D_8034C4B0_main_menu_vpk0, 0, NULL, 1);
    if (1) {
    }
    if (1) {
    }
...
void func_800E251C_A09AAC(void) {
    ...
    gobj = D_800E82D4_A0F864 = ohCreateSprite(0xE, ohUpdateDefault, 0, 0x80000000, renDrawSprite, 1, 0x80000000, -1,
                                              &D_8034D3A0_main_menu_vpk0, 0, NULL, 1);
    if (1) {
    }
    if (1) {
    }
...
void func_800E25B8_A09B48(void) {
    ...
    gobj = D_800E82D8_A0F868 = ohCreateSprite(0xE, ohUpdateDefault, 0, 0x80000000, renDrawSprite, 1, 0x80000000, -1,
                                              &D_802F6490_main_menu_vpk0, 0, NULL, 1);
    if (1) {
    }
    if (1) {
    }
...
void func_800E2654_A09BE4(void) {
    ...
    gobj = D_800E82DC_A0F86C = ohCreateSprite(0xE, ohUpdateDefault, 0, 0x80000000, renDrawSprite, 1, 0x80000000, -1,
                                              &D_8034B020_main_menu_vpk0, 0, NULL, 1);
    sobj = gobj->data.sobj;

    func_800E18A0_A08E30(sobj, SP_TEXSHUF | SP_HIDDEN | SP_TRANSPARENT);
    func_800E18FC_A08E8C(sobj, 0x28, 0x83);
    omGObjAddSprite(gobj, &D_8034BBB8_main_menu_vpk0);

    sobj = sobj->next;
    func_800E18A0_A08E30(sobj, SP_TEXSHUF | SP_HIDDEN | SP_TRANSPARENT);
    func_800E18E0_A08E70(sobj, 0x80, 0x80, 0x80);
    func_800E18FC_A08E8C(sobj, 170, 172);
    omGObjAddSprite(gobj, &D_8034C710_main_menu_vpk0);
...
void func_800E2780_A09D10(void) {
    ...
    gobj = D_800E82E0_A0F870 = ohCreateSprite(0xE, ohUpdateDefault, 0, 0x80000000, renDrawSprite, 1, 0x80000000, -1,
                                              &D_8034FAD8_main_menu_vpk0, 0, NULL, 1);
    sobj = gobj->data.sobj;
...
void func_800E28CC_A09E5C(void) {
    ...
    ohRemoveSprite(gobj);
    omGObjAddSprite(gobj, &D_802E8DD0_main_menu_vpk0);
