...
s32 func_801E28D8_9D9248(UnkStruct800BEDF8* arg0, s32* arg1) {
    ...
    if ((arg0->unk_18 & 0x10000) && !(arg0->unk_14 & 0xC0000)) {
        do {
            *arg1 = (*arg1 + 7) % 8;
        } while (D_80230E14_A27784[*arg1].unk_0 == 35);
        auPlaySound(0x41);
    }
...
s32 func_801E2EB0_9D9820(void) {
    ...
    while (true) {
        ...
        if (sp2C->unk_18 & 0x8000) {
            auPlaySound(0x42);
            switch (D_80230E14_A27784[D_80202EC0_9F9830].unk_0) {
                case 2:
    ...
    while (true) {
        ...
        switch (D_80203008_9F9978) {
            case 0:
                ...
                if (sp2C->unk_18 & 0x8000) {
                    auPlaySound(0x42);
                    switch (D_80230E14_A27784[sp28].unk_0) {
                        case 29:
            ...
            case 4:
                if (func_801E28D8_9D9248(sp2C, &sp28) != 0) {
                    ...
                    if (D_80230E14_A27784[sp28].unk_0 == 5) {
                        auPlaySound(0x42);
                        func_801DDCD4_9D4644(0);
                        func_801DE078_9D49E8(0);
                        func_803700A4_843854(1);
                        ...
                        auPlaySound(0x44);
                        func_801DE5A8_9D4F18(D_80230E14_A27784[sp28].unk_0);
                    }
                }
        }
        ohWait(1);
    ...
    while (true) {
        ...
        if (!sp30) {
            ...
            if (sp3C->unk_18 & 0x8000) {
                auPlaySound(0x42);
                switch (D_80230E14_A27784[sp38].unk_0) {
                    case 29:
                        sp2C = 0;
                        sp28 = 0;
