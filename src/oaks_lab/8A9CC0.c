...
void func_800E467C_8A9E9C(void) {
    ...
    char* sp54[] = {
        "\\w\\1\\LHello there\\t, %s!\nI'm Oak, the Pok\xE9mon professor.",
        NULL,
    };

    char* sp3C[] = {
        "\\2The reason I invited you here\nis \\Mthis PKMN Report.",
        "I'd like for you to take\npictures of Pok\xE9mon\nfor the PKMN Report.",
        "H\\3\\Mere on Pok\xE9mon Island,\nwild Pok\xE9mon can be\nfound everywhere.",
