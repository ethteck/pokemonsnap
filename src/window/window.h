...
void UIElement_FillRect(UnkSnowHerring*, s32, s32, s32, s32, s32, s32, s32, s32);
void func_8036A8E4_83E094(UnkSnowHerring*);
void UIElement_FillRectDefault(UnkSnowHerring*, s32, s32, s32, s32);
void UIElement_FillRectWithBorder(UnkSnowHerring*, UNK_TYPE, UNK_TYPE, s32, s32, s32, s32, s32, s32);
UnkSnowHerring* UIElement_Create(s32, s32, s32, s32, s32);
void UIElement_Delete(UnkSnowHerring*);
void UIElement_SwapImages(UnkSnowHerring*);
void func_8036B734_83EEE4(UnkSnowHerring*);
void UIElement_SetColor(UnkSnowHerring*, s32, s32, s32, s32, s32);
...
void UIElement_PrintText2(UnkSnowHerring*, char*);
void func_8036CB58_840308(UnkSnowHerring*, s32);
void UIElement_SetPos(UnkSnowHerring*, s32 x, s32 y);
...
void func_8036D77C_840F2C(UIText*, ucolor*, ucolor*);
void func_8036E490_841C40(UIText* arg0, s32* arg1, s32* arg2, u8* arg3);
void func_8036E9BC_84216C(UIText* arg0, s32* arg1, s32* arg2, u8* arg3);
void func_8036E9BC_84216C(UIText*, s32*, s32*, u8*);
