...
void func_801DDD28_9A7F78(s32, bool);
...
void func_801DE998_9A8BE8(bool);
void func_801DEA4C_9A8C9C(bool, s32 column, s32 row);
...
void album_DrawDeletePhotoPrompt(bool);
