...
extern Sprite report_bg_sprite;
extern Sprite report_silhouette_sprite;
extern Sprite report_divider_sprite;
extern Sprite report_title_sprite;
extern Sprite report_bg_alt_sprite;
extern Sprite report_best_shot_left_sprite;
extern Sprite report_best_shot_right_sprite;
extern Sprite report_best_shot_top_sprite;
extern Sprite report_best_shot_bottom_sprite;
extern Sprite report_divider_vertical_sprite;
extern Sprite report_divider_horizontal_sprite;
extern Sprite report_row_icon_sprite;
extern Sprite report_row_fill_sprite;
extern Sprite report_frame_vertical_sprite;
extern Sprite report_frame_horizontal_sprite;
extern Sprite report_frame_sm_vertical_sprite;
extern Sprite report_frame_sm_horizontal_sprite;
extern Sprite report_large_fill_sprite;
...
GObj* func_801DF4AC_9D5E1C(s32 arg0) {
    ...
    gobj = func_80371C68_845418(NULL, 6, &report_frame_sm_vertical_sprite);
    sobj = gobj->data.sobj;
    sobj->sprite.x = x;
    sobj->sprite.y = y;
    D_80230DC8_A27738[arg0].unk_00 = gobj;

    sobj = func_80371E68_845618(sobj, &report_frame_sm_vertical_sprite);
    sobj->sprite.x = 54;
    sobj->sprite.y = 0;

    sobj = func_80371DC0_845570(sobj, &report_frame_sm_horizontal_sprite);
    sobj->sprite.x = 2;
    sobj->sprite.y = 0;
...
void* func_801DF884_9D61F4(s32 arg0) {
    ...
    sobj->sprite = report_frame_vertical_sprite;
    sobj->sprite.x = 127;
    sobj->sprite.y = 43;
    ...
    sobj = sobj->next;
    sobj->sprite = report_frame_horizontal_sprite;
    sobj->sprite.x = 3;
    sobj->sprite.y = 0;
...
void func_801DFC20_9D6590(s32 arg0) {
    ...
    D_80230C14_A27584->sprite = report_large_fill_sprite;
...
GObj* func_801DFD68_9D66D8(void) {
    ...
    D_80230C10_A27580 = gobj = func_80371C68_845418(NULL, 6, &report_frame_vertical_sprite);
    ...
    sobj = func_80371E68_845618(sobj, &report_frame_vertical_sprite);
    sobj->sprite.x = 143;
    sobj->sprite.y = 0;

    sobj = func_80371DC0_845570(sobj, &report_frame_horizontal_sprite);
    sobj->sprite.x = 3;
    sobj->sprite.y = 0;
    ...
    sobj = func_80371DC0_845570(sobj, &report_large_fill_sprite);
    sobj->sprite.x = 3;
    sobj->sprite.y = 3;
...
GObj* func_801DFE9C_9D680C(void) {
    ...
    sobj = sobj->next;
    sobj->sprite = report_large_fill_sprite;
    sobj->sprite.x = 3;
    sobj->sprite.y = 3;
...
void func_801E01C4_9D6B34(void) {
    GObj* sp1C = func_80371D14_8454C4(0, 6, &report_title_sprite);
    ...
    sp18 = func_80371DC0_845570(sp18, &report_silhouette_sprite);
    sp18->sprite.x = 149;
    sp18->sprite.y = 116;
    ...
    sp18 = func_80371DC0_845570(sp18, &report_divider_sprite);
    sp18->sprite.x = 124;
    sp18->sprite.y = 168;
...
void func_801E02F4_9D6C64(void) {
    ...
    SObj* sobj = omGObjAddSprite(gobj, &report_bg_sprite);
    ...
    sobj = omGObjAddSprite(gobj, &report_title_sprite);
    sobj->sprite.x = 106;
    sobj->sprite.y = 52;
    sobj->unk_58 = NULL;
    sobj->unk_5C = NULL;
    ...
    sobj = func_80371DC0_845570(sobj, &report_silhouette_sprite);
    sobj->sprite.x = 149;
    sobj->sprite.y = 116;
    ...
    sobj = func_80371DC0_845570(sobj, &report_divider_sprite);
    sobj->sprite.x = 124;
    sobj->sprite.y = 168;
...
void func_801E0480_9D6DF0(void) {
    ...
    sobj = omGObjAddSprite(gobj, &report_bg_alt_sprite);
    sobj->unk_58 = NULL;
    sobj->unk_5C = NULL;
    sobj->sprite.width = SCREEN_WIDTH;
    sobj->sprite.height = SCREEN_HEIGHT;
    ...
    gobj = D_80230C60_A275D0;
    sobj = omGObjAddSprite(gobj, &report_divider_horizontal_sprite);
    sobj->unk_58 = NULL;
    sobj->unk_5C = NULL;
    sobj->sprite.x = 112;
    sobj->sprite.y = 63;
    sobj->sprite.attr &= ~SP_SCALE;
    D_80230C48_A275B8[0] = sobj;
    sobj = func_80371DC0_845570(sobj, &report_divider_vertical_sprite);
    sobj->sprite.x = 154;
    sobj->sprite.y = 173;
    sobj->sprite.attr |= SP_HIDDEN;
    D_80230C48_A275B8[1] = sobj;
    ...
    gobj = func_80371D14_8454C4(0, 6, &report_row_fill_sprite);
    sobj = gobj->data.sobj;
    sobj->sprite.x = 102;
    sobj->sprite.y = 67;
    sobj->sprite.alpha = 0x80;
    ...
    sobj = func_80371DC0_845570(sobj, &report_row_icon_sprite);
    sobj->sprite.x = 96;
    sobj->sprite.y = 67;
    sobj->sprite.attr |= SP_HIDDEN;
...
void func_801E07C0_9D7130(void) {
    ...
    gobj = D_80230C60_A275D0;
    sobj = omGObjAddSprite(gobj, &report_divider_vertical_sprite);
    sobj->unk_58 = NULL;
    sobj->unk_5C = NULL;
    sobj->sprite.x = 154;
    sobj->sprite.y = 173;
    ...
    sobj = gobj->data.sobj;
    sobj->sprite = report_best_shot_left_sprite;
    sobj->sprite.x = 112;
    sobj->sprite.y = 21;

    sobj = sobj->unk_58;
    sobj->sprite = report_best_shot_right_sprite;
    sobj->sprite.x = 158;
    sobj->sprite.y = 0;

    sobj = sobj->next;
    sobj->sprite = report_best_shot_top_sprite;
    sobj->sprite.x = 18;
    sobj->sprite.y = 0;

    sobj = sobj->next;
    sobj->sprite = report_best_shot_bottom_sprite;
    sobj->sprite.x = 18;
    sobj->sprite.y = 123;
...
void func_801E2790_9D9100(void) {
    ...
    gobj = func_80371D14_8454C4(0, 6, &report_bg_sprite);
    sobj = gobj->data.sobj;
    sobj->sprite.width = SCREEN_WIDTH;
    sobj->sprite.height = SCREEN_HEIGHT;
    sobj->sprite.istep = 0;
