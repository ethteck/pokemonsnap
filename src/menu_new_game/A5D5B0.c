...
extern Sprite new_game_cursor_sprite; // cursor
...
void func_800E2E00_A5E1B0(void) {
    ...
    D_8016814C = 0;
    D_80168148 = ohCreateSprite(14, ohUpdateDefault, 0, 0x80000000, renDrawSprite, 1, 0x80000000, -1, &new_game_cursor_sprite, 0, func_800E2D18_A5E0C8, 1);
    unk_48 = D_80168148->data.sobj;
