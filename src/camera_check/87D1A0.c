...
s32 func_camera_check_801DFCD4(UnkStruct800BEDF8* arg0, s32* arg1, s32* arg2, s32 arg3) {
    ...
    if (arg0->pressedButtons & STICK_SLOW_UP) {
        if (*arg2 > 0) {
            (*arg2)--;
        }
    }
...
s32 func_camera_check_801E04F4(s32 arg0) {
    ...
    while (true) {
        ...
        if (temp_s4->pressedButtons & B_BUTTON) {
            auPlaySound(0x48);
            FocusMark_Show(true);
            return 0;
        }

        if ((temp_s4->pressedButtons & A_BUTTON) && !func_camera_check_801E2EF4(temp_s1->unk_08)) {
            auPlaySound(0x48);
            FocusMark_Show(true);
            return 0;
        }
        ...
        temp_s1 = func_camera_check_801E24D8(D_camera_check_80208960);
        if ((temp_s4->pressedButtons & A_BUTTON) && temp_s1 != NULL) {
            UIElement_Draw(func_camera_check_801DCB40());
        ...
        if (temp_s1 != NULL && (func_800BF3D4_5C274(temp_s1->unk_08) || (func_camera_check_801E286C(temp_s1->unk_08) != NULL)) && (temp_s4->pressedButtons & Z_TRIG)) {
            ...
            while (func_800AA38C(0)->currentButtons & Z_TRIG) {
                ohWait(1);
            }
        ...
        if (temp_s4->pressedButtons & (STICK_RIGHT | STICK_LEFT)) {
            if (temp_s4->pressedButtons & STICK_RIGHT) {
                if (D_camera_check_80208960 < (func_camera_check_801E2534() - 1)) {
            ...
            if (temp_s4->pressedButtons & STICK_LEFT) {
                if (D_camera_check_80208960 > 0) {
                    D_camera_check_80208960--;
                    func_camera_check_801DE80C(1, D_camera_check_80208960, 9);
                    var_s5 = true;
...
s32 func_camera_check_801E0B5C(bool arg0) {
    ...
    for (;; ohWait(1)) {
        ...
        if (((temp_v0_2->pressedButtons & A_BUTTON) && (var_s0 = func_camera_check_801E24D8(D_camera_check_80208960), (var_s0 != NULL))) || var_s1) {
        ...
        var_s0 = func_camera_check_801E24D8(D_camera_check_80208960);
        if ((temp_v0_2->pressedButtons & B_BUTTON) || var_s1) {
            if (var_s0 != NULL) {
...
s32 func_camera_check_801E0F10(void) {
    ...
    while (true) {
        ...
        if ((temp_v0->pressedButtons & A_BUTTON) && (func_camera_check_801E24D8(D_camera_check_80208960) != NULL)) {
            prevMode = -1;
            func_camera_check_801E24D8(D_camera_check_80208960);
            ...
            if (temp_v0->pressedButtons & B_BUTTON) {
                return 0;
            } else {
                if (var_s6) {
                    var_s6 = false;
...
s32 func_camera_check_801E15B4(s32 arg0) {
    ...
    while (true) {
        ...
        if (temp_v1 & 0xC00000) {
            ...
            if (temp_s6->pressedButtons & STICK_LEFT) {
                if (D_camera_check_80208960 > 0) {
                    D_camera_check_80208960--;
                    func_camera_check_801DE80C(1, D_camera_check_80208960, 0xC);
                    var_s5 = true;
...
s32 func_camera_check_801E1BD4(void) {
    ...
    while (1) {
        ...
        if (temp_s0->pressedButtons & A_BUTTON) {
...
u32 func_camera_check_801E1EA4(void) {
    ...
    while (1) {
        temp_v0 = func_800AA38C(0);
        if (temp_v0->pressedButtons & A_BUTTON) {
            D_camera_check_80208960 = 0;
            if (func_camera_check_801E27FC()) {
        ...
        if ((temp_v0->pressedButtons & STICK_SLOW_RIGHT) && ((D_camera_check_80208960 - (D_camera_check_80208960 % 6)) < (func_camera_check_801E2534() - 6))) {
            auPlaySound(SOUND_ID_75);
            D_camera_check_80208960 += 6;
            D_camera_check_80249AA0(D_camera_check_80208960 - (D_camera_check_80208960 % 6), 0x15);
            func_camera_check_801E03EC();
        }
        if ((temp_v0->pressedButtons & STICK_SLOW_LEFT) && ((D_camera_check_80208960 - (D_camera_check_80208960 % 6)) > 0)) {
            auPlaySound(SOUND_ID_75);
            D_camera_check_80208960 -= 6;
            D_camera_check_80249AA0(D_camera_check_80208960 - (D_camera_check_80208960 % 6), 0x15);
            func_camera_check_801E03EC();
