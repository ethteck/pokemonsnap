...
extern Sprite D_801E5DB0_995820_sprite;
extern Sprite D_801E5EE0_995950_sprite;
extern Sprite D_801F2378_9A1DE8_sprite; // Prof. Oak's check
extern Sprite D_801F26B0_9A2120_sprite; // NEW
extern Sprite D_801F2910_9A2380_sprite; // blue diamond background
extern Sprite D_801F29F0_9A2460_sprite; // evaluation background sprite
extern Sprite D_801F2AD0_9A2540_sprite; // black square
extern Sprite D_801F3B10_9A3580_sprite;
...
void func_801DD568_98CFD8(void) {
    GObj* gobj = func_80371D14_8454C4(NULL, 6, &D_801F29F0_9A2460_sprite);
...
GObj* func_801DD720_98D190(s32 idx) {
    ...
    gobj = func_80371C68_845418(NULL, 6, &D_801E5DB0_995820_sprite);
    sobj = gobj->data.sobj;
    D_802290A0_9D8B10[idx].gobj = gobj;
    sobj = func_80371E68_845618(sobj, &D_801E5DB0_995820_sprite);
    sobj->sprite.x = 54;
    sobj->sprite.y = 0;
    sobj = func_80371DC0_845570(sobj, &D_801E5EE0_995950_sprite);
    sobj->sprite.x = 2;
    sobj->sprite.y = 0;
    sobj = func_80371DC0_845570(sobj, &D_801E5EE0_995950_sprite);
    sobj->sprite.x = 2;
    sobj->sprite.y = 41;
    sobj = func_80371DC0_845570(sobj, &D_801F3B10_9A3580_sprite);
    sobj->sprite.x = 2;
    sobj->sprite.y = 2;
...
void func_801E3FFC_993A6C(void) {
    ...
    gobj = func_80371D14_8454C4(0, 6, &D_801F2910_9A2380_sprite);
    sobj = gobj->data.sobj;
    sobj->sprite.width = SCREEN_WIDTH;
    ...
    gobj = func_80371D14_8454C4(0, 6, &D_801F2378_9A1DE8_sprite);
    ...
    gobj = func_80371D14_8454C4(0, 6, &D_801F26B0_9A2120_sprite);
    D_80229184_9D8BF4 = gobj->data.sobj;
    D_80229184_9D8BF4->sprite.x = 217;
    D_80229184_9D8BF4->sprite.y = 23;
    func_801DD638_98D0A8(0);

    gobj = func_80371D14_8454C4(0, 6, &D_801F2AD0_9A2540_sprite);
