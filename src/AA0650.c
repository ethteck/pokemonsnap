...
// external data
extern Sprite D_802BC0C0_intro_code_vpk0;
...
GObj* func_800E18A0_AA0650(void) {
    ...
    temp_v0 =
        ohCreateSprite(0xE, ohUpdateDefault, 0, 0x80000000, renDrawSprite, 1, 0x80000000, -1, &D_802BC0C0_intro_code_vpk0, 0, NULL, 1);
