...
void func_80346C64_8263D4(void) {
    ...
    scriptDesc = func_800A73C0((u32) fx_script_rainbow_ROM_START, (u32) fx_script_rainbow_ROM_END);
    spritesDesc = func_800A73C0((u32) fx_img_rainbow_ROM_START, (u32) fx_img_rainbow_ROM_END);
    if (scriptDesc != NULL && spritesDesc != NULL) {
