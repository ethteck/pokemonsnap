...
UNK_TYPE* album_D_80250120_A1A370;
UIButton* album_D_80250124_A1A374;
...
s32 func_801E1A50_9ABCA0(UnkStruct800BEDF8* input, s32* arg1) {
    ...
    if ((input->pressedButtons & STICK_SLOW_UP) && !(input->currentButtons & STICK_MASK_SLOW)) {
        do {
            *arg1 = (*arg1 + 7) % 8;
        } while (album_D_80250124_A1A374[*arg1].id == BUTTON_END);
        auPlaySound(0x41);
    }
...
s32 func_801E2874_9ACAC4(void) {
    ...
    while (true) {
        ...
        if (input->pressedButtons & A_BUTTON) {
            auPlaySound(0x42);
            switch (album_D_80250124_A1A374[sp28].id) {
                case 30:
        ...
        switch (sp40) {
            case 0:
                ...
                if (input->pressedButtons & 0x8000) {
                    auPlaySound(0x42);
                    switch (album_D_80250124_A1A374[sp48].id) {
                        case 20:
...
void func_801E37A0_9AD9F0(void) {
    ...
    sp28 = 1;
    album_D_80250120_A1A370 = album_MainButtonsDef;
    album_D_80250124_A1A374 = UILayout_GetButtons();
    D_80208B94_9D2DE4 = 0;
