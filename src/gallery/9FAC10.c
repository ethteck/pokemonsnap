...
GObj* func_801DD28C_9FAF4C(s32 arg0) {
    ...
    gobj = func_80371C68_845418(NULL, 6, &D_801E82A0_A05F60_sprite);
    sobj = gobj->data.sobj;
    sobj->sprite.x = x;
    sobj->sprite.y = y;
    D_80230818_A4E4D8[arg0].gobj = gobj;

    sobj = func_80371E68_845618(sobj, &D_801E82A0_A05F60_sprite);
    sobj->sprite.x = 54;
    sobj->sprite.y = 0;

    sobj = func_80371DC0_845570(sobj, &D_801E83D0_A06090_sprite);
    sobj->sprite.x = 2;
    sobj->sprite.y = 0;
    ...
    sobj = func_80371DC0_845570(sobj, &D_801EA1B0_A07E70_sprite);
    sobj->sprite.x = 2;
    sobj->sprite.y = 2;
...
void func_801DE318_9FBFD8(s32 arg0) {
    switch (arg0) {
        case 0:
            D_8023086C_A4E52C->sprite = D_801E8FB0_A06C70_sprite;
            break;
        case 1:
            D_8023086C_A4E52C->sprite = D_801E8890_A06550_sprite;
            break;
        case 2:
            D_8023086C_A4E52C->sprite = D_801E8D50_A06A10_sprite;
            break;
    }
...
void func_801DEE88_9FCB48(void) {
    ...
    if (D_801EA1F4_A07EB4 != 0 && contIsPrinterAvailable()) {
        ...
        if (func_801E1504_9FF1C4(1) != 0) {
            sp28 = func_80371D14_8454C4(NULL, 6, &D_801E80E8_A05DA8_sprite);
...
void func_801DF078_9FCD38(GObj* arg0) {
    ...
    while (true) {
        ...
        if (D_801EA1FC_A07EBC != 0) {
            ...
            UIElement_PrintText(D_80230880_A4E540, "\\eNow Saving...");
            if (func_801E1504_9FF1C4(1) != 0) {
                gobj = func_80371D14_8454C4(NULL, 6, &D_801E80E8_A05DA8_sprite);
...
void func_801DF788_9FD448(void) {
    ...
    obj = func_80371D14_8454C4(NULL, 6, &D_801E8FB0_A06C70_sprite);
    sobj = obj->data.sobj;
