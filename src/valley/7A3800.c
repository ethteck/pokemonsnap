...
void func_802CA2BC_7A384C(GObj* arg0) {
    Pokemon_ForceAnimation(arg0, &D_802D3084_7AC614);
    Pokemon_SetState(arg0, func_802CA364_7A38F4);
}

void func_802CA2F4_7A3884(GObj* arg0) {
    Pokemon_ForceAnimation(arg0, &D_802D3098_7AC628);
    Pokemon_SetState(arg0, func_802CA364_7A38F4);
}

void func_802CA32C_7A38BC(GObj* arg0) {
    Pokemon_ForceAnimation(arg0, &D_802D30AC_7AC63C);
    Pokemon_SetState(arg0, func_802CA364_7A38F4);
}
