...
extern Sprite D_802E6B18_7C00A8_sprite;
extern Sprite D_802EC4D8_7C5A68_sprite;
...
void func_802CFE8C_7A941C(void) {
    ...
    spX2Move(&omGObjAddSprite(gobj, &D_802E6B18_7C00A8_sprite)->sprite, 100, 34);
    ...
    sprite = omGObjAddSprite(gobj, &D_802EC4D8_7C5A68_sprite);
